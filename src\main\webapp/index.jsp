...
<h1 style="color:rgb(55,123,181)">Taxing App by Team 4</h1>
...
<input type="submit" class="btn btn-primary" value="Press here to Proceed">
...
<br>
<br><hr>
All rights reserved by team4 &copy<br>
</div>
<% 
